...
export default function SortFilterPopup({ onClose, onApply, initialFilters, initialSort }) {
  ...
  const sortOptions = [
    ...
    { id: 'rating-asc', label: 'Ratings - ascending' },
    { id: 'rating-desc', label: 'Ratings - descending' },
      ...
      <div className="sort-filter-popup" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="popup-header">
          {activeCategories.length > 0 && (
            <div className="active-category-pills">
        ...
        <div className="filter-section">
          <div className="range-header">
            <label className="filter-label">Ratings</label>
